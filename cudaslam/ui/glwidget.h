...
protected:
	...
	/// 3D content drawing
	virtual void drawRobot(float x, float y, float yaw, float ranges[361]);
	...
	float laser_angles[361]; // cached map of laser angles
	...
	float lookat_x, lookat_y, eye_yaw, eye_pitch, eye_r; // viewing angle
	float lookat_x_old, lookat_y_old, eye_yaw_old, eye_pitch_old; // copy of viewing angle
