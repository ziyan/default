...
public class NodeLookupResponseMessage extends Message {
	...
	public static final Creator CREATOR = new Creator() {
		...
		protected Message create(final InetSocketAddress source, byte type, byte priority, byte[] data, int offset, int length) throws Exception {
			...
			return new NodeLookupResponseMessage(source, null, nodeId, new InetSocketAddress(InetAddress.getByAddress(addr), port));
		}
	};
	...
	public NodeLookupResponseMessage(final InetSocketAddress source, final InetSocketAddress destination, short nodeId, InetSocketAddress address) {
