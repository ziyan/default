...
public class ModuleQueryRequestMessage extends Message {
	public static final byte TYPE = 0x25;
	...
	public static final Creator CREATOR = new Creator() {
		...
		protected Message create(final InetSocketAddress source, byte type, byte priority, byte[] data, int offset, int length) throws Exception {
			...
			return new ModuleQueryRequestMessage(source, null, new String(data, offset, length));
		}
	};

	protected final String moduleId;

	public ModuleQueryRequestMessage(final InetSocketAddress source, final InetSocketAddress destination, String moduleId) {
