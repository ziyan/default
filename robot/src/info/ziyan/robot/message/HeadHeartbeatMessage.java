/*
 * File: HeadHeartbeatMessage.java is part of info.ziyan.robot.message.
...
public class HeadHeartbeatMessage extends Message{
	...
	public static final Creator CREATOR = new Creator() {
			...
			protected Message create(final InetSocketAddress source, byte type, byte priority, byte[] data, int offset, int length) {
				...
				return new HeadHeartbeatMessage(source, null);
			}
		};
	
	public HeadHeartbeatMessage(final InetSocketAddress source, final InetSocketAddress destination) {
