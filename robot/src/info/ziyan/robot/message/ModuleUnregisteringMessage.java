...
public class ModuleUnregisteringMessage extends Message {
	...
	public static final Creator CREATOR = new Creator() {
		...
		protected Message create(final InetSocketAddress source, byte type, byte priority, byte[] data, int offset, int length) throws Exception {
			...
			return new ModuleUnregisteringMessage(source, null, nodeId, moduleId);
		}
	};
	...
	public ModuleUnregisteringMessage(final InetSocketAddress source, final InetSocketAddress destination, short nodeId, String moduleId) {
