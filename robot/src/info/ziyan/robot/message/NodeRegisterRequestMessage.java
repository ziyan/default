...
public class NodeRegisterRequestMessage extends Message {
	...
	public static final Creator CREATOR = new Creator() {
			...
			protected Message create(final InetSocketAddress source, byte type, byte priority, byte[] data, int offset, int length) throws Exception {
				...
				return new NodeRegisterRequestMessage(source, null, nodeId);
			}
		};

	protected final short nodeId;

	public NodeRegisterRequestMessage(final InetSocketAddress source, final InetSocketAddress destination, short nodeId) {
