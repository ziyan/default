...
public class NodeTerminatingMessage extends Message{
	...
	public static final Creator CREATOR = new Creator() {
			...
			protected Message create(final InetSocketAddress source, byte type, byte priority, byte[] data, int offset, int length) {
				...
				return new NodeTerminatingMessage(source, null, nodeId);
			}
		};
	
	protected final short nodeId;
	
	public NodeTerminatingMessage(final InetSocketAddress source, final InetSocketAddress destination, short nodeId) {
