...
public class ModuleRegisterResponseMessage extends Message {
	public static final byte TYPE = 0x23;
	...
	public static final Creator CREATOR = new Creator() {
		...
		protected Message create(final InetSocketAddress source, byte type, byte priority, byte[] data, int offset, int length) throws Exception {
			...
			return new ModuleRegisterResponseMessage(source, null, nodeId, moduleId);
		}
	};
	...
	public ModuleRegisterResponseMessage(final InetSocketAddress source, final InetSocketAddress destination, short nodeId, String moduleId) {
