/*
 * File: NodeHeartbeatMessage.java is part of info.ziyan.robot.message.
...
public class NodeLookupRequestMessage extends Message{
	...
	public static final Creator CREATOR = new Creator() {
			...
			protected Message create(final InetSocketAddress source, byte type, byte priority, byte[] data, int offset, int length) {
				...
				return new NodeLookupRequestMessage(source, null, nodeId);
			}
		};
	
	protected final short nodeId;
		
	public NodeLookupRequestMessage(final InetSocketAddress source, final InetSocketAddress destination, short nodeId) {
